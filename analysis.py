...
sel_blocktype = st.sidebar.multiselect("Block Type", sorted(df_main['Block Type'].dropnan().unique()),
                                    default=sorted(df_main['Block Type'].dropnan().unique()))
...
with tabs[0]:
    ...
    if chart_type == "Boxplot":
        ...
        pivot = df_filtered.pivot_table(values=y_axis, index=x_axis, columns=color_dim, aggfunc='mean')
